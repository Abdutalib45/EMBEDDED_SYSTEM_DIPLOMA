 ...
 *((volatile uint32_t *)(0x400FE000 +0x108)) = 0x00000020;
 delay(200);
 *((volatile uint32_t *)(0x40025000 +0X400)) |=1<<3;
 *((volatile uint32_t *)(0x40025000 +0X51C)) |=1<<3;
 while (1)
 {
  *((volatile uint32_t *)(0x40025000 +0X3FC)) |=1<<3;
  delay(20000);
  *((volatile uint32_t *)(0x40025000 +0X3FC)) &=~(1<<3);
  delay(20000);
